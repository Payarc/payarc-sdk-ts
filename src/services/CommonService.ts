...
export class CommonService {
	...
	constructor(private bearerToken: string | null, private bearerTokenAgent: string | null, private baseURL: string, private version: string) {
	...
	static manageError(seed: Record<string, any>, error: any): Record<string, any> {
		return {
			...seed,
